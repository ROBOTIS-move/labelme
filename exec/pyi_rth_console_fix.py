...
# -*- coding: utf-8 -*-
"""
PyInstaller runtime hook to fix console output issues on Windows.
This hook ensures stdout/stderr are properly initialized for both GUI and console modes.
"""
